...
<?php include("Header.php");?>
    ...
    <div class="lastest container mt-4 mt-sm-5">
        <div class="row"  style="color: white;">
            <div class="col-lg-6">
                <h2 class="font-weight-bolder float-left">Your Watch History Manga</h2>
            </div>
            <div class="col-lg-6">
        ...
        <?php
            ...
            $sql = "SELECT manga.id,chapter_view.chapter as'chapter',type,image1,manga.creationdate,genre,written,chapter_view.date FROM manga,chapter_view WHERE chapter_view.manga=manga.id and chapter_view.user=$get_id ORDER BY chapter_view.date DESC";
            ...
            <div class="col-lg-2 col-md-3 col-sm-4" style="float: left;">
                <div class="card mb-3" >
                    ...
                    <p class="card-text"><?php echo substr(htmlentities($result->title),0,12); ?></p>
